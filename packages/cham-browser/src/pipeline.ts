...
function entryToRange(entry: AnnotationEntry, doc: ChamDocument): OutputRange | null {
...
function buildAnnotations(doc: ChamDocument, pieceId: number): OutputAnnotation[] {
...
function buildAnnotationsFromLayer(
...
function getHeadword(doc: ChamDocument, ann: OutputAnnotation): string {
...
function buildAnnotationsText(doc: ChamDocument, annotations: OutputAnnotation[]): string {
...
function parseCommentaryLayers(
  files: Map<string, string>,
...
export function buildDynastiesJson(allPieces: OutputPiece[]): Record<string, object> {
